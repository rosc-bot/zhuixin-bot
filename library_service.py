...
class LibraryService:
    ...
    async def get_radar_summary(
        ...
        for entry in library_entries:
            ...
            is_fully_collected = bool(tot_eps) and len(collected) >= tot_eps
            is_ongoing = (not is_tmdb_ended and not is_fully_collected) or bool(future_numbers) or (bool(tot_eps) and len(collected) < tot_eps)
